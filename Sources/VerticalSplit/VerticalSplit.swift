...
>: View {
    ...
    public var body: some View {
        ...
        ZStack {
            ...
            .animation(.spring(response: 0.3, dampingFraction: 0.7), value: hideTop)
            .animation(.spring(response: 0.3, dampingFraction: 0.7), value: hideBottom)
            ...
            ZStack {
                Capsule()
                    ...
                    .transaction({ t in
                        t.animation = .easeInOut(duration: 0.4)
        ...
        .onChange(of: detent) { _, newValue in
            ...
            var t = transaction
            t.animation = .smooth(duration: 0.4)
            withTransaction(t) {
                didUpdateSplit(split: detent)
            }
        }
